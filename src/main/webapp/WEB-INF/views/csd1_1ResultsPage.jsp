...
try{
	...
	ResultSet rs = stmt.executeQuery("select * from csd1_1 inner join csd1_1results where csd1_1.student_id = csd1_1results.student_id and csd1_1.student_id = '"+student_id1+"' ");
...
<center> <a href="#" class="logo"><img src="images/aiti.png" width="500" height="110"></a> </center>
    <a href="dgiOneView.html" style="text-decoration: none;"><img src="images/back.jpeg" width="40" height="40"></a>
  <hr class="new1">
<style>
table{
  width:100%;
