        ...
        <div class="modal-body">
						...
						<form action="editCsd1_1StudentInfo" method="post">
							...
							<div class="modal-body">
								...
								<div class="modal-footer">
									<button type="submit" onclick="return validate()"><img src="${pageContext.request.contextPath }/resources/images/Update.png" width="50" height="50" id="sweetalert"></button>
