  ...
  <div class="card-body">
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<form action="saveCsd1_1Student" method="post" onclick="return validate()">
							...
							<div class="modal-body">
								...
								<div class="modal-footer">
								    <button type="submit" class="btn btn-primary" id="alert">Add</button>
	...
	<tbody>
			...
			<c:forEach items="${student}" var="student">
				...
				<c:url value="/aitiStudents/deleteCsd1_1StudentInfo" var="deleteURL">
				<c:param name="student_id" value="${student.student_id }"></c:param>
				</c:url>
  ...
  <div class="card-body">
	...
	<tbody>
			...
			<c:forEach items="${studentResults}" var="csd1_1StudentResults">
				...
				<c:url value="updateCsd1_1StudentResult" var="updateURL">
					...
					<c:url value="/aitiStudents/deleteCsd1_1StudentResult" var="deleteURL">
					<c:param name="student_id" value="${csd1_1StudentResults.student_id }"></c:param>
				</c:url>


				<tr><td>${csd1_1StudentResults.id }</td>
