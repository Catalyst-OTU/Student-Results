...
<div class="container">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
						...
						<form action="addCsd1_1StudentResult" method="post">

							<div class="modal-body">
							
							
								<input type="hidden" name="id" value="${param.csd1_1.id}" />
							
								<div class="form-group">
									<label>STUDENT ID</label> <input name="student_id"
										type="text" readonly="readonly" class="form-control" value="${param.csd1_1.student_id}" required>
								</div>
