...
<div class="container">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
						...
						<form action="editCsd1_1StudentResult" method="post">
							...
							<div class="modal-body">
								...
								<div class="modal-footer">
									...
									<a href="${pageContext.request.contextPath }/studentInfo/getCsd1_1Page"><img src="${pageContext.request.contextPath }/resources/images/back.jpeg" width="50" height="50"></a>
								</div>
